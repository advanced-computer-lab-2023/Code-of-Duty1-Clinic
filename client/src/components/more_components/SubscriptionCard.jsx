...
const SubscriptionCard = (Package) => {
  ...
  const handleSubscription = () => {
    if (subscribed) {
      ...
      axios
        .post('http://localhost:3000/payment/session/${Package.price}/${Package.name}', {})
        .then((response) => {
  ...
  return (
    <Card>
      <CardContent>
        ...
        <Typography color="text.secondary">Price: {Package.price}</Typography>
        ...
        <Button variant="contained" onClick={handleSubscription} sx={{ mt: 2 }}>
