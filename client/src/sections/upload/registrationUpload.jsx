...
function RegistrationUpload() {
    ...
    const handleUploadSuccess = (field) => {
        let idx = 0;
        if (field == 'medicalLicenses')
            idx = 1;
        else if (field == 'medicalDegree')
            idx = 2;
        isUploaded[idx] = 1;
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            <Upload url={url} labelName="Medical licenses" field="medicalLicenses" handleUploadSuccess={handleUploadSuccess} />
