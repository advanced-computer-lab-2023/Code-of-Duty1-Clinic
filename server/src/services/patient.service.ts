...
export { viewDoctorsForPatient as viewAllDoctorsForPatient, getFamily, addFamilyMember,saveMedicalHistory,removeMedicalHistory,getMedicalHistoryURL,getMedicalHistory };
