...
import { getPatients, selectPatient, getAllDoctors } from '../services/doctor.service';
...
import { addAdmin, deleteUsers, getUsers, updateInfo, getDoctorsRequests } from '../services/user.service';
...
router.get('/doctors', (req: Request, res: Response) => {
  ...
  controller(res)(getAllDoctors)(req.query);
});
//admin to show request
router.get('/doctors/requests', (req: Request, res: Response) => controller(res)(getDoctorsRequests)(req.query));
