...
UserMeRouter.get('/me/patient/', (req, res) => controller(res)(getPatients)(req.query.doctorID));
UserMeRouter.get('/me/patient/:id', (req, res) => controller(res)(selectPatient)(req.query.doctorID, req.params.id));
