    ...
    try {
      const response = await fetch('http://localhost:3070/auth/register/patient', {
        ...
        body: JSON.stringify({
          ...
          name: { first: values.name, last: values.name + ' last' },
          emergencyContact: [
            {
              name: values.emergencyContact_fullName,
              phone: values.emergencyContact_mobileNumber,
    ...
    try {
      const response = await fetch('http://localhost:3070/auth/register/doctor', {
        ...
        body: JSON.stringify({
          ...
          phone: values.mobileNumber,
          name: {
            first: values.doctorName,
            last: values.doctorName + ' last'
          },
          email: values.doctorEmail,
          password: values.doctorPassword,
          hospital: values.affiliation,
                ...
                <Form>
                  <TabPanel>
                    ...
                    <Field name="emergencyContact_fullName">
                      {({ field, form }) => (
                        <FormControl
                          isInvalid={form.errors.emergencyContact_fullName && form.touched.emergencyContact_fullName}
                        >
                    ...
                    <Field name="emergencyContact_mobileNumber">
                      {({ field, form }) => (
                        <FormControl
                          isInvalid={
                            form.errors.emergencyContact_mobileNumber && form.touched.emergencyContact_mobileNumber
                          }
                        >
                          ...
                          <Input
                            {...field}
                            type="numeric"
                            id="emergencyContact_mobileNumber"
                      ...
                      {({ field, form }) => (
                        <FormControl isInvalid={form.errors.relation && form.touched.relation}>
                          <FormLabel htmlFor="relation">
                            emergencyContact_relation [ 'Husband' | 'Wife' | 'Child']
                          </FormLabel>
                    ...
                    {/* Submit button */}
                    <Button mt={6} colorScheme="teal" isLoading={formik.isSubmitting} type="submit" isFullWidth>
                      Register
                    </Button>
                  </TabPanel>
                </Form>
                ...
                <Form>
                  <TabPanel>
                    ...
                    <Field name="educationalBackground">
                      {({ field, form }) => (
                        <FormControl
                          isInvalid={form.errors.educationalBackground && form.touched.educationalBackground}
                        >
